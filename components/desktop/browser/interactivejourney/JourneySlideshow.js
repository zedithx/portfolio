        ...
        return (
            <div className="relative w-full h-full flex items-center justify-center overflow-hidden p-3 sm:p-2 md:p-4 lg:p-6">
                <motion.div
                    ...
                    exit={{ opacity: 0 }}
                >
                    <GameFrame className="w-full max-w-2xl flex flex-col items-center justify-center p-8 md:p-12">
                        <LoadingSpinner 
                            message="LOADING SUMMARY..."
                            subMessage="Preparing your journey report"
                        />
                    </GameFrame>
                </motion.div>
            </div>
    ...
    if (showSummary) {
        ...
        return (
            <SummaryView
                ...
                onToggleToFormal={onToggleToFormal}
            ...
            <section className="w-full h-full flex flex-col relative lg:overflow-hidden">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {/* Desktop Popup - Mobile and Desktop */}
                        <DesktopPopup
                            isOpen={showDesktopPopup}
                            skills={skills}
